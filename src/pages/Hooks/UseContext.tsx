...
const UseContext = () => {
  return (
    <div className="m-10 sm:m-20">
      <h1 className="heading">Use Context Hook (Context API)</h1>
      <div className="text-2xl">
        ...
        <li>
          ...
          elements of your choosing. This is very helpful when many components
          modify or display the same state. This can be helpful for adding
          dark/light mode functionality or checking if the user is logged in.
        </li>
        <li>
        ...
        <li>
          ...
          which wraps around children. Any React hooks can be used inside the
          context component. In this example, a custom hook is used. This
          completes the initialization process. To access the context just
          import it like a component and then pull the arguments from it, using
          destructuring. This looks similar to the state hook. UseContext3.png
        </li>
