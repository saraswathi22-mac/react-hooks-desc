...
import img2 from "../../assets/useCallbackWhy.jpg";
import img3 from "../../assets/useCallbackPurpose.jpg";
import img4 from "../../assets/useCallbackPurposeMain.jpg";

const UseCallback = () => {
  return (
    <div className="m-10 sm:m-20">
      <h1 className="heading">Use Callback Hook</h1>
      <div className="text-2xl">
        ...
        <li>
          ...
          code source but they are different function objects. Comparing them
          sum1 === sum2 evaluates to false.
        </li>
        <li>
        ...
        <li>
          ...
          MyComponent. Inline functions are cheap, the re-creation of functions
          on each rendering is not a problem.
        </li>
        <li>
        ...
        <ol>
          <li>
            A functional component wrapped inside React.memo() accepts a
